# Contributing Guidelines for Streamer
...
- [Contributing Guidelines for Streamer](#contributing-guidelines-for-Streamer)
  - [Contents](#contents)
...
To make a GitHub issue for Streamer, please visit the [new issue page](https://github.com/Streamer/Streamer/issues/new/choose) where you can pick either the "Bug Report" or "Feature Request" template.
...
After an issue is created, it will be assigned either the https://github.com/Streamer/Streamer/labels/bug or https://github.com/Streamer/Streamer/labels/feature label, along with https://github.com/Streamer/Streamer/labels/awaiting-approval. One of our maintainers will review your issue and, if it's accepted, will set the https://github.com/Streamer/Streamer/labels/approved label.

## Before you start!

Before starting a contribution, please check your contribution is part of an open issue on [our issues page](https://github.com/Streamer/Streamer/issues?q=is%3Aopen+is%3Aissue+label%3Aapproved).

GitHub issues are how we track our bugs and feature requests that will be implemented into Streamer - all contributions **must** have an issue and be approved by a maintainer before a pull request can be worked on.
...
Also, make sure that the issue you would like to work on has been given the https://github.com/Streamer/Streamer/labels/approved label by a maintainer. Otherwise, if we reject the issue, it means your work will have gone to waste!

## Contributing

If you're here because you'd like to work on an issue, amazing! Thank you for even considering contributing to Streamer; it means a lot :heart:
...
Our recommended development environment to work on Streamer is:
...
- Keep as much as possible to the style of Streamer. Look around our codebase to familiarise yourself with how we do things!
...
Language contributions help Streamer massively, allowing people worldwide to use our app!
